...
import './App.css';
import abhiImage from "./Nihith.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Nihith" />
          <h3 className="name">Nihith</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Nihith</span></h1>
      </section>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i>nihithreddy1909@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9121749242 </h3>
